        ...
        <FieldSet>
          ...
          <FieldGroup>
            ...
            <Field>
              ...
              />
              <FieldDescription className="text-xs">
                请填写 I-DO 调用的模型名字，模型必须支持工具调用、图像识别等功能。
              </FieldDescription>
            </Field>
            <Field>
      ...
      <FieldGroup>
        <FieldSet>
          ...
          <FieldDescription className="text-sm">
            模型上下文协议 (MCP) 通过集成外部工具来增强 I-DO 的性能，例如私有域搜索、网页浏览、订餐、PPT 生成等任务。
          </FieldDescription>
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="!max-w-[850px]">
        ...
        <DialogHeader className="border-b pb-4">
          <DialogTitle className="text-gray-700">I-DO 设置</DialogTitle>
          <DialogDescription className="text-gray-500">在此管理您的 I-DO 设置。</DialogDescription>
        </DialogHeader>
